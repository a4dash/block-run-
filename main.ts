namespace SpriteKind {
    ...
    export const thg = SpriteKind.create()
    export const fng = SpriteKind.create()
}
...
scene.onOverlapTile(SpriteKind.Player, img`
            myTile2
        `, function (sprite3, location2) {
    game.gameOver(true)
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.fng, function (sprite2, otherSprite) {
    sprites.destroy(otherSprite)
    bepe = sprites.create(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
    ...
    bepe.setPosition(bots.x + 80, bots.y - 80)
    bepe.follow(bots)
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (sprite5, otherSprite3) {
    sprites.destroy(otherSprite3)
    if (bots.y < otherSprite3.y) {
        info.changeScoreBy(3)
    } else {
        info.changeLifeBy(-1)
    }
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.COIN, function (sprite4, otherSprite2) {
...
let bepe: Sprite = null
let fng2: Sprite = null
let bots: Sprite = null
...
bots = sprites.create(img`
    ...
    . . . e e e . e e e . . . . . . 
    `, SpriteKind.Player)
controller.moveSprite(bots, 100, 0)
bots.ay = 350
scene.cameraFollowSprite(bots)
info.setLife(3)
for (let value of tiles.getTilesByType(assets.tile`transparency16`)) {
    fng2 = sprites.create(img`
        . . . . . . . . . . . . . . . . 
        . . . . f f f f f f f . . . . . 
        . . . f 5 5 5 5 5 5 5 f . . . . 
